...
public class FormalParamError2 extends FormParameterList {

    private FormalParameterDeclaration FormalParameterDeclaration;

    public FormalParamError2 (FormalParameterDeclaration FormalParameterDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamError2(\n");
